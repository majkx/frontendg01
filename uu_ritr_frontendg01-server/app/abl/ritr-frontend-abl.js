...
const Errors = require("../api/errors/ritr-frontend-error.js");
...
const logger = LoggerFactory.get("RitrFrontendAbl");

class RitrFrontendAbl {
  constructor() {
...
module.exports = new RitrFrontendAbl();
